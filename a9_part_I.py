...
if __name__ == "__main__":
    ...
    print(f"day is: {date_matches.group(2)}!")   # should print "day is: 16"
    print(f"year is: {date_matches.group(3)}!")  # should print "year is: 2008"
    assert date_matches.group(1) == 'January', "Incorrect month"
    assert date_matches.group(2) == '16', "Incorrect day"
